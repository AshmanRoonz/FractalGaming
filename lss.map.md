...
- **(v35.40)** DOM parts moved into their layout slots in CSS: `#minimap` bottom-centre, round, `12vmin`; `#kill-feed` `8vmin/4vmin`; `#fps-counter` `4vmin/4vmin`; `#round-info` pushed to `4.6vmin` to clear the compass strip the layout puts at top centre.
